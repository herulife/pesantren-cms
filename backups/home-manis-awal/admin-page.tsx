...
import { Globe, GraduationCap, Newspaper, Settings, Users, Wallet } from 'lucide-react';
...
const quickLinks = [
  {
    ...
    description: 'Buka halaman home dan lihat tampilan website pengunjung.',
    icon: Globe,
    roles: ['panitia_psb', 'tim_media', 'superadmin'],
  },
  {
    href: '/admin/psb',
    label: 'Kelola PSB',
    ...
    <div className="space-y-8">
      <section className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-white via-emerald-50/60 to-teal-50/60 p-8 shadow-sm">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
          Kelola modul utama Darussunnah melalui pintasan cepat untuk konten, data santri,
          pengaturan sistem, dan kebutuhan operasional harian.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-amber-100 bg-amber-50/70 p-6 text-sm leading-6 text-amber-900 shadow-sm">
        Gunakan kartu pintasan di atas untuk membuka modul yang paling sering dipakai, lalu
        lanjutkan pengelolaan konten, pendaftaran, dan pengaturan sesuai kebutuhan harian.
      </section>
    </div>
  );
}
