  ...
  return (
    <section className="bg-[linear-gradient(180deg,#f8fafc_0%,#ffffff_100%)] py-16 md:py-24">
      <div className="container mx-auto max-w-6xl px-4">
        <PublicSectionIntro eyebrow="Agenda" title={title} description={subtitle} />
        {isLoading ? (
          <PublicGridSkeleton count={3} className="mt-8 grid gap-4 md:grid-cols-3" itemClassName="h-52 rounded-[1.8rem]" />
        ) : agendas.length > 0 ? (
